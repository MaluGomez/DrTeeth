    ...
    <v-layout wrap pa-5>
      ...
      <v-flex col-12>
        <v-card elevation="24">
          ...
          <v-layout wrap>
            <v-flex col-12>
              <v-card class="mx-auto  " max-width="800" elevation="24">
                <v-card-title>
                  <v-icon x-large center style="color: black ;">
                    mdi-account
                  </v-icon>
                  <span class=" title font-weight-light " style="color: black ;"
                    >Datos Paciente</span
                  >
                </v-card-title>
                <v-flex col-12>
